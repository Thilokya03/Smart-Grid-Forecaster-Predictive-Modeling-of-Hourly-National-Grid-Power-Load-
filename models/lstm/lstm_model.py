...
# ============================================================
# FIXED CONFIGURATION
# Keep these the same as the selected demand-only LSTM
# ============================================================
...
# ============================================================
# MODEL
# Same architecture as the existing demand-only LSTM
# ============================================================
...
def create_fold_windows(
    ...
    bad_step = pd.Series(time_index).diff().ne(pd.Timedelta(hours=1)).to_numpy(
        dtype=np.int64
    )
    bad_step[0] = 0
    ...
    for start in range(
        ...
        # Never train or validate on a window that crosses a missing hour.
        if cumulative_bad_steps[target_end - 1] - cumulative_bad_steps[start] != 0:
            continue
...
def main():
    ...
    print()
    print("=" * 70)
    print("FINAL LSTM 4-FOLD CV RESULTS")
    print("=" * 70)
